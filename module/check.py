...
class Check:
    ...
    def check_5_x_route_rce_get(self):
        ...
        try:
            for poc in pocs:
                ...
                res = requests.get(payload, headers=headers, timeout=10)
    ...
    def check_5_x_construct_rce(self):
        try:
            ...
            for poc in pocs:
                res = requests.post(poc_url, data=poc, headers=headers, timeout=10)
                bs = BeautifulSoup(res.text, 'html.parser')
                verify = bs.find_all('h1')
                for row in verify:
                    rows = re.match("PHP Version", row.text)
        ...
        try:
            ...
            for poc in pocs:
                ...
                if res.status_code == 200:
                    ...
                    print(host)
                    res = requests.get(host, headers=headers, timeout=10)
                    if res.status_code == 200:
                        self.poc = poc
    ...
    def check_5_0_x_db(self):
        ...
        try:
            ...
            res_usr = requests.get(payload_usr, headers=headers, timeout=10)
            res_pwd = requests.get(payload_pwd, headers=headers, timeout=10)
    ...
    def check_5_x_sql(self):
        ...
        try:
            ...
            for poc in pocs:
                ...
                res = requests.get(poc_url, headers=headers, timeout=10)
                bs = BeautifulSoup(res.text, 'html.parser')
    ...
    def check_5_x_xff_sql(self):
        try:
            ...
            res = requests.get(poc_url, headers=self.headers, timeout=10)
            bs = BeautifulSoup(res.text, 'html.parser')
    ...
    def check_5_x_time_sql(self):
        try:
            ...
            res = requests.post(poc_url, data=payload, headers=self.headers, timeout=10)
